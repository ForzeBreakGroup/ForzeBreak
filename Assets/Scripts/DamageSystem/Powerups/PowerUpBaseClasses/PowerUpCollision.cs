...
public class PowerUpCollision : PowerUpProjectileBase, IComponentCollision
{
    ...
    protected virtual void ApplyDamage(string powerupname)
    {
        ...
        {
            Debug.Log("PowerUp: " + powerupname + " Applying Damage on Player #" + PowerUpData.OwnerID + " Applying Damage (" + damage + ") to Player #" + targetDmgSystem.gameObject.GetPhotonView().ownerId);
